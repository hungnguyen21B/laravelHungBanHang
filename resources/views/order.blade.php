...
<div class="container">
    <div id="content">       
    <form role="form" action="{{route('postdathang')}}" method="post" class="beta-form-checkout">
        {{csrf_field()}}
            <div class="row">
                <div class="col-sm-6">
                    <h4>Đặt hàng</h4>
                ...
                <div class="col-sm-6">
                    <div class="your-order">
                        ...
                        <div class="text-center"><button type="submit"><a class="beta-btn primary">Đặt hàng <i class="fa fa-chevron-right"></i></a></button></div>
                    </div> <!-- .your-order -->
                </div>
            </div>
        </form>
